"""
Django settings for dh5 project.
"""
...
DATATYPE_LOCATIONS.append('dh5.datatypes')
FUNCTION_LOCATIONS.append('dh5.functions')
SEARCH_COMPONENT_LOCATIONS.append('dh5.search_components')
...
SECRET_KEY = 'aayxe)#wf^recneo%a=bxvmqi$3u&z+v+(8j$=1vkhqb+ypt!!'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = 'dh5.urls'

# a prefix to append to all elasticsearch indexes, note: must be lower case
ELASTICSEARCH_PREFIX = 'dh5'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'dh5.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = 'dh5.wsgi.application'
